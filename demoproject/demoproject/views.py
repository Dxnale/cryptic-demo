...
def execute_command(request):
    ...
    try:
        ...
        try:
            ...
            return JsonResponse({
                ...
                'analysis_data': {
                    ...
                    'has_sensitive_data': bool(analysis.sensitive_analysis and analysis.sensitive_analysis.matches),
                }
            })

        except Exception as e:
            logger.error(f"Error en análisis para usuario {request.user.username}: {str(e)}")
            return JsonResponse({
                'success': False,
        ...
        return JsonResponse({
            'success': False,
            'output': 'Error: Formato JSON inválido',
            'error': True
        })
    except Exception as e:
